  ...
  packages/
    ...
    site/                   # squisq-site (dev/demo, not published)
      src/
        ...
        documentImport.ts   # Upload → markdown: registry-backed DOCX/PPTX/XLSX/PDF/CSV/HTML/
                            #   zip import; prefers a format’s importContainer so embedded
                            #   media rides along into the editor workspace
...
`@bendyline/squisq` exposes 18 subpath entries (canonical list — every entry matches a tsup
