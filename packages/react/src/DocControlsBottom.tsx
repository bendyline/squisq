 ...
 * indicator, CC toggle, fullscreen toggle. Same controls as the overlay but in
 * an external bar. Like the other variants, fullscreen appears only when the
 * host wires `actions.toggleFullscreen`.
 *
 * Related Files:
