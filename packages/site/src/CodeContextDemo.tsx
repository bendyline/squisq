    ...
    () => ({
      fileTop: {
        ...
        markdown: [
          ...
          '',
          '**Imports (2)**',
          '- [`src/resolver.ts`](workspace-nav:src%2Fresolver.ts)',
          '- [`src/api.ts`](workspace-nav:src%2Fapi.ts)',
        ].join('\n'),
      ...
      sections: [
        {
          ...
          markdown: streamed
            ? [
                ...
                '',
                '**Imported by (3)**',
                '- [`src/pages/home.ts`](workspace-nav:src%2Fpages%2Fhome.ts)',
                '- [`src/pages/settings.ts`](workspace-nav:src%2Fpages%2Fsettings.ts)',
                '',
