 ...
 * 1. Automation-friendly - tools can create docs from source content
 * 2. Browser-renderable - SVG + CSS animations (ES2015 compatible)
 * 3. Video-exportable - Frame-by-frame capture via Playwright
 *
 * Timing: Blocks can be timed to narration audio segments and grouped by
 * segment for synchronized playback.
 */
