...
## Step 4: Evaluate Codex Skills & Instructions
...
- **Conventions:** Are coding conventions clearly stated? Would a new Codex session
  follow them?
...
Read each skill in `.Codex/skills/*/SKILL.md` and evaluate:

**For each skill, ask:**

1. Would a fresh Codex session follow this skill correctly without additional context?
...
## Codex Skills & Instructions Review
...
- [ ] Read every SKILL.md in `.Codex/skills/`
...
8. Codex skills and AGENTS.md assessment with specific update recommendations
