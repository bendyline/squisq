  ...
  packages/
    core/                   # @bendyline/squisq
      src/
        ...
        doc/
          templates/        # 26 block templates (title, sectionHeader, content, statHighlight,
          ...
          page/             # Page (linear) mode materialization — the variable-height HTML
                            ...
                            #   (all 26 templates → section drafts), materializePageSections
